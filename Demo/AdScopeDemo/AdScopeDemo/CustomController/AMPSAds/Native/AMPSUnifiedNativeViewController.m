//
//  AMPSUnifiedNativeViewController.m
//  AdScopeDemo
//
//  Created by nie adhub on 2025/3/27.
//

#import "AMPSUnifiedNativeViewController.h"
...
@interface AMPSUnifiedNativeViewController () <UITextFieldDelegate>
...
@implementation AMPSUnifiedNativeViewController
...
- (void)viewDidLoad {
    ...
    self.spaceIdTextField.text = @"117907";
...
- (void)requestBtnClick {
    ...
    AMPSUnifiedNativeDetailViewController *viewController = [[AMPSUnifiedNativeDetailViewController alloc]init];
...
- (void)dealloc {
    CookieAMPSLog(@"AMPSUnifiedNativeViewController dealloc");
}
