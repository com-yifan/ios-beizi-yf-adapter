//
//  AMPSNativeExpressViewController.m
//  AdScopeDemo
//
//  Created by Cookie on 2023/6/1.
//

#import "AMPSNativeExpressViewController.h"
...
@interface AMPSNativeExpressViewController () <UITextFieldDelegate>
...
@implementation AMPSNativeExpressViewController
...
- (void)viewDidLoad {
    ...
    self.spaceIdTextField.text = @"15354";
...
- (void)requestBtnClick {
    ...
    AMPSNativeExpressListViewController *viewController = [[AMPSNativeExpressListViewController alloc]init];
